...
bronze_data AS (
    ...
    FROM landing_data
        ...
        WHERE LOADED_AT > COALESCE((SELECT MAX(LOADED_AT) FROM "DQP_BRONZE"."dbo"."bronze_jh_ddmant"),'1970-01-01 00:00:00.000')
