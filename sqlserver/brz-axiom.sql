...
WITH landing_data AS (
    SELECT
        ...
        DATE_OF_DATA
    FROM
        "DQP_LANDING"."dbo"."AXIOM_deposits"
)
...
WITH landing_data AS (
    SELECT
        ...
        DATE_OF_DATA
    FROM
        "DQP_LANDING"."dbo"."AXIOM_dmi_chargeoffs"
)
...
WITH landing_data AS (
    SELECT
        ...
        DATE_OF_DATA
    FROM
        "DQP_LANDING"."dbo"."AXIOM_dmiloans"
)
...
WITH landing_data AS (
    SELECT
        ...
        ,REPLACE(
            InstrumentID,
            LEFT(InstrumentID, CHARINDEX('_', InstrumentID)),
            ''
        ) AS InstrumentCode
        ,ITYPE
        ,ACCT
        ...
        ,YRMO AS YEARMONTH
    FROM
        "DQP_LANDING"."dbo"."AXIOM_instmodelstg"
)
...
WITH landing_data AS (
    SELECT
        ...
        DATE_OF_DATA
    FROM
        "DQP_LANDING"."dbo"."AXIOM_ovrntdep"
)
