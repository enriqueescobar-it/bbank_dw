...
WITH landing_data AS (
    SELECT
        ...
        TRY_CAST(crdt_lmt_23_35 AS real) AS crdt_lmt_23_35,
        TRY_CAST(curr_bal_36_48 AS real) AS curr_bal_36_48,
        TRY_CAST(avail_credit_49_61 AS real) AS avail_credit_49_61,
        TRY_CAST(outstanding_auth_amt_62_74 AS real) AS outstanding_auth_amt_62_74,
        ...
        primary_nm_99_124,
        TRY_CAST(mnth_to_dt_pymnt_125_137 AS real) AS mnth_to_dt_pymnt_125_137,
        TRY_CAST(lst_stmnt_bal_138_150 AS real) AS lst_stmnt_bal_138_150,
        TRY_CAST(amt_of_lst_pymnt_151_163 AS real) AS amt_of_lst_pymnt_151_163,
        ...
        TRY_CAST(pymnt_due_201_213 AS real) AS pymnt_due_201_213,
        ...
        TRY_CAST(tot_bal_fwd_csh_283_295 AS real) AS tot_bal_fwd_csh_283_295,
        ...
        TRY_CAST(curr_pymnt_fxd_328_340 AS real) AS curr_pymnt_fxd_328_340,
        ...
        TRY_CAST(lf_hgh_bal_amt_390_402 AS real) AS lf_hgh_bal_amt_390_402,
        TRY_CAST(lst_addrss_chng_dt_403_410 AS int) AS lst_addrss_chng_dt_403_410,
        TRY_CAST(dspt_amt_411_423 AS real) AS dspt_amt_411_423,
        ...
        TRY_CAST(secr_crd_crr_bal_543_555 AS real) AS secr_crd_crr_bal_543_555,
        ...
        TRY_CAST(tot_bal_frwrd_744_756 AS real) AS tot_bal_frwrd_744_756,
        ...
        TRY_CAST(crdt_lf_prem_775_787 AS real) AS crdt_lf_prem_775_787,
        ...
        TRY_CAST(lst_nsf_amt_827_839 AS real) AS lst_nsf_amt_827_839,
        TRY_CAST(amt_lst_lt_chrg_840_852 AS real) AS amt_lst_lt_chrg_840_852,
        TRY_CAST(dt_acct_opnd_853_860 AS int) AS dt_acct_opnd_853_860,
        TRY_CAST(curr_tot_due_861_873 AS real) AS curr_tot_due_861_873,
        embssng_ln_4_874_898,
        TRY_CAST(tot_ytd_fin_chrg_pd_899_911 AS real) AS tot_ytd_fin_chrg_pd_899_911,
        TRY_CAST(ytd_purch_amt_912_924 AS real) AS ytd_purch_amt_912_924,
        TRY_CAST(ytd_purch_num_925_929 AS int) AS ytd_purch_num_925_929,
        TRY_CAST(ytd_lt_fee_pd_fees_930_942 AS real) AS ytd_lt_fee_pd_fees_930_942,
        TRY_CAST(ctd_amnt_csh_adv_fee_943_955 AS real) AS ctd_amnt_csh_adv_fee_943_955,
        TRY_CAST(ctd_misc_fee_956_968 AS real) AS ctd_misc_fee_956_968,
        TRY_CAST(ytd_fees_chrgd_969_981 AS real) AS ytd_fees_chrgd_969_981,
        TRY_CAST(typ_prcssng_982_983 AS int) AS typ_prcssng_982_983,
        TRY_CAST(ltd_lt_chrg_amt_984_996 AS real) AS ltd_lt_chrg_amt_984_996,
        TRY_CAST(lt_chrg_ytd_997_1009 AS real) AS lt_chrg_ytd_997_1009,
        ...
        TRY_CAST(fin_chrg_ytd_1041_1053 AS real) AS fin_chrg_ytd_1041_1053,
        ...
        TRY_CAST(intrst_pd_lst_yr_1095_1107 AS real) AS intrst_pd_lst_yr_1095_1107,
        TRY_CAST(ach_py_amt_1108_1120 AS real) AS ach_py_amt_1108_1120,
        ...
        TRY_CAST(lst_annl_fee_amt_1654_1666 AS real) AS lst_annl_fee_amt_1654_1666,
        ...
        TRY_CAST(tmp_crdt_lmt_1700_1712 AS real) AS tmp_crdt_lmt_1700_1712,
        TRY_CAST(dt_lst_tmp_crd_lmt_1713_1720 AS int) AS dt_lst_tmp_crd_lmt_1713_1720,
        TRY_CAST(orgnl_crd_lmt_1721_1733 AS real) AS orgnl_crd_lmt_1721_1733,
        ...
        TRY_CAST(ovrlm_hstry_24_01_1788_1811 AS real) AS ovrlm_hstry_24_01_1788_1811,
        TRY_CAST(auto_py_dy_1812_1813 AS int) AS auto_py_dy_1812_1813,
        TRY_CAST(auto_py_amt_1814_1826 AS real) AS auto_py_amt_1814_1826,
        ...
        TRY_CAST(new_bal_purch_1859_1871 AS real) AS new_bal_purch_1859_1871,
        TRY_CAST(new_bal_csh_1872_1884 AS real) AS new_bal_csh_1872_1884,
        TRY_CAST(new_bal_specl_1885_1897 AS real) AS new_bal_specl_1885_1897,
        TRY_CAST(csh_adv_lmt_1898_1910 AS real) AS csh_adv_lmt_1898_1910,
        TRY_CAST(csh_adv_avail_1911_1923 AS real) AS csh_adv_avail_1911_1923,
        TRY_CAST(ctd_prncpl_purch_1924_1936 AS real) AS ctd_prncpl_purch_1924_1936,
        TRY_CAST(ctd_prncpl_csh_1937_1949 AS real) AS ctd_prncpl_csh_1937_1949,
        TRY_CAST(ctd_prncpl_spcl_1950_1962 AS real) AS ctd_prncpl_spcl_1950_1962,
        TRY_CAST(ctd_pymnt_1963_1975 AS real) AS ctd_pymnt_1963_1975,
        ...
        TRY_CAST(chrg_off_amt_2054_2066 AS real) AS chrg_off_amt_2054_2066,
        ...
        TRY_CAST(ovrlmt_amt_2277_2289 AS real) AS ovrlmt_amt_2277_2289,
        TRY_CAST(tot_pst_due_amt_2290_2302 AS real) AS tot_pst_due_amt_2290_2302,
        TRY_CAST(tot_clcltd_pymnt_due_2303_2315 AS real) AS tot_clcltd_pymnt_due_2303_2315,
        ...
        (select LastProcessDate from "DQP_CONTROL"."dbo"."CONTROL_GENERAL_CALENDAR" cgc where process_date = (select MAX(CONVERT(DATE,LOADED_AT)) from  "DQP_LANDING"."dbo"."FIS_CD300")) AS DATE_OF_DATA,
        CONVERT(INT, CONVERT(nvarchar(6), LOADED_AT, 112)) AS YEARMONTH,
        TRY_CAST(LOADED_AT AS datetime) AS LOADED_AT
    FROM
        "DQP_LANDING"."dbo"."FIS_CD300"
),
...
bronze_data AS(
    ...
    FROM landing_data
        ...
        WHERE CONVERT(date, LOADED_AT) > COALESCE((SELECT MAX(LOADED_AT) FROM "DQP_BRONZE"."dbo"."bronze_fis_cd300"),'1970-01-01 00:00:00.000')
...
SELECT bd.*, GETUTCDATE() AS LOADED_AT  FROM bronze_data bd inner join "DQP_CONTROL"."dbo"."CONTROL_GENERAL_CALENDAR" cgc ON
process_date = convert(DATE,GETUTCDATE())
where JHCoreProcessDay = 'Y'
...
WITH landing_data AS (
    SELECT
        ...
        ,LOADED_AT
    FROM
    "DQP_LANDING"."dbo"."FIS_ETHOS_Interchange_FEE_Data"
),
...
WITH landing_data AS (
    SELECT
        ...
        [status],
        pt,
        CONVERT(INT, beg_bal) AS beg_bal,
        CONVERT(INT, base_pts) AS base_pts,
        CONVERT(INT, promo_pts_earned) AS promo_pts_earned,
        CONVERT(INT, scoremore_pts_earned) AS scoremore_pts_earned,
        CONVERT(INT, relation_pts_earned) AS relation_pts_earned,
        CONVERT(INT, curr_adjusted) AS curr_adjusted,
        CONVERT(INT, curr_redeemed) AS curr_redeemed,
        CONVERT(INT, curr_exp) AS curr_exp,
        CONVERT(INT, curr_avail) AS curr_avail,
        CONVERT(INT, anticipated_to_exp) AS anticipated_to_exp,
        non_statused_acct_to,
        grand_tot,
        CONVERT(DATE, processed_at) as processed_at,
        CONVERT(DATE, data_date) AS DATE_OF_DATA,
        CONVERT(INT, FORMAT(CAST(data_date AS DATE), 'yyyyMM')) AS YEARMONTH
    FROM
