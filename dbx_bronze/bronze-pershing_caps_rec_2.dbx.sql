...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_caps_rec_2 AS
SELECT
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_caps_rec_2 IS
'Bronze Pershing table bronze_pershing_caps_rec_2 contains trade, commission, revenue, security, and settlement records sourced from landing_pershing.default.pershing_caps_2 for warehouse parity, validation, reconciliation, and downstream reporting.';
