...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_fund_rec_a AS
SELECT
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_fund_rec_a IS
'Bronze Pershing table bronze_pershing_fund_rec_a contains security, fund, pricing, income, and product reference records sourced from landing_pershing.default.pershing_fund_a for warehouse parity, validation, reconciliation, and downstream reporting.';
