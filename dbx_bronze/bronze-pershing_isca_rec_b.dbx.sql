...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_isca_rec_b AS
SELECT
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_isca_rec_b IS
'Bronze Pershing table bronze_pershing_isca_rec_b contains security, fund, pricing, income, and product reference records sourced from landing_pershing.default.pershing_isca_b for warehouse parity, validation, reconciliation, and downstream reporting.';
