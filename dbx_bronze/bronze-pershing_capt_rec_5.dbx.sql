...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_capt_rec_5 AS
SELECT
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_capt_rec_5 IS
'Bronze Pershing table bronze_pershing_capt_rec_5 contains trade, commission, revenue, security, and settlement records sourced from landing_pershing.default.pershing_capt_5 for warehouse parity, validation, reconciliation, and downstream reporting.';
