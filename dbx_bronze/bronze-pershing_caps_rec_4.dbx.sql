...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_caps_rec_4 AS
SELECT
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_caps_rec_4 IS
'Bronze Pershing table bronze_pershing_caps_rec_4 contains trade, commission, revenue, security, and settlement records sourced from landing_pershing.default.pershing_caps_4 for warehouse parity, validation, reconciliation, and downstream reporting.';
