...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_isca_rec_g AS
SELECT
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_isca_rec_g IS
'Bronze Pershing table bronze_pershing_isca_rec_g contains security, fund, pricing, income, and product reference records sourced from landing_pershing.default.pershing_isca_g for warehouse parity, validation, reconciliation, and downstream reporting.';
