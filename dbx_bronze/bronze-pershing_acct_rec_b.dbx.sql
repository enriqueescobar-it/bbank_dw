...
CREATE OR REPLACE TABLE bronze_pershing.default.bronze_pershing_acct_rec_b AS
SELECT
    `TRANSACTION_CODE`,
...
COMMENT ON TABLE bronze_pershing.default.bronze_pershing_acct_rec_b IS
'Bronze Pershing table bronze_pershing_acct_rec_b contains account, registration, client, status, and relationship records sourced from landing_pershing.default.pershing_acct_b for warehouse parity, validation, reconciliation, and downstream reporting.';
