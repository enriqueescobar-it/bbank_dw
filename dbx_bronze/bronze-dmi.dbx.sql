...
WITH landing_data AS (
    SELECT
        ...
        AGGR,
        NEXTDUE,
        TRY_CAST(FIRSTPB AS DECIMAL(19,3)) AS FIRSTPB,
        TRY_CAST(ORGMTGAMT AS DECIMAL(17,3)) AS ORGMTGAMT,
        LOANDATE,
        MATDATE,
        CASE
        	WHEN ANNUALINT LIKE '%E%'
        	THEN TRY_CAST(TRY_CAST(TRIM(ANNUALINT) AS DOUBLE) AS DECIMAL(17,6))
        ELSE TRY_CAST(ANNUALINT AS DECIMAL(17,6))
        END AS ANNUALINT,
        LOANTERM,
        REMTERM,
        PRODLINECD,
        ...
        LOTYPEDESC,
        FIRSTDUE,
        TRY_CAST(FIRSTPI AS DECIMAL(17,3)) AS FIRSTPI,
        TRY_CAST(FSTSERFEE AS DECIMAL(20,6)) AS FSTSERFEE,
        FORECLSCOD,
        FORECLSDES,
        TRY_CAST(ORGLTV AS DECIMAL(13,3)) AS ORGLTV,
        INTPDTHRU,
        TRY_CAST(ESCROWBAL AS DECIMAL(17,3)) AS ESCROWBAL,
        TRY_CAST(ESCROWADV AS DECIMAL(17,3)) AS ESCROWADV,
        PLGCODE,
        PLGDESC,
        PMNTPERD,
        BADCHKTBLE,
        TIMESDLQ,
        TRY_CAST(TOTPMNT AS DECIMAL(19,3)) AS TOTPMNT,
        NOOFUNIT,
        INTFLAG,
        INTFLAGDES,
        CAPLNFLAG,
        ...
        MTGRFNAME,
        MTGRHAZPAY,
        TRY_CAST(TIPMNT AS DECIMAL(17,3)) AS TIPMNT,
        TRY_CAST(GUARFEE AS DECIMAL(17,3)) AS GUARFEE,
        RECFLAG,
        RECFLAGDES,
        POOLNUM,
        DLQPMNTCNT,
        ...
        PREPMNTIND,
        FHLBBPP,
        TRY_CAST(FSTORGCOST AS DECIMAL(17,3)) AS FSTORGCOST,
        TRY_CAST(FSTORIGFEE AS DECIMAL(17,3)) AS FSTORIGFEE,
        TRY_CAST(FSTUNAMORT AS DECIMAL(17,3)) AS FSTUNAMORT,
        ARMIREFFDT,
        TRY_CAST(ARMORGIR AS DECIMAL(20,6)) AS ARMORGIR,
        TRY_CAST(ARMMARGIN AS DECIMAL(19,6)) AS ARMMARGIN,
        ARMPIEFFDT,
        ARMCHGPRD,
        TRY_CAST(ARMPICHGPR AS DECIMAL(8,2)) AS ARMPICHGPR,
        TRY_CAST(ARMIRMAXCL AS DECIMAL(20,6)) AS ARMIRMAXCL,
        TRY_CAST(ARMIRMAXFL AS DECIMAL(20,6)) AS ARMIRMAXFL,
        TRY_CAST(ARMIMAXINC AS DECIMAL(20,6)) AS ARMIMAXINC,
        TRY_CAST(ARMIMAXDEC AS DECIMAL(20,6)) AS ARMIMAXDEC,
        TRY_CAST(AIRMAXLINC AS DECIMAL(20,6)) AS AIRMAXLINC,
        TRY_CAST(AIRMAXLDEC AS DECIMAL(20,6)) AS AIRMAXLDEC,
        TRY_CAST(APIMAXPCTI AS DECIMAL(20,6)) AS APIMAXPCTI,
        TRY_CAST(APIMAXPCTD AS DECIMAL(20,6)) AS APIMAXPCTD,
        TRY_CAST(APIMAXLIFE AS DECIMAL(20,6)) AS APIMAXLIFE,
        TRY_CAST(APIPCTMINC AS DECIMAL(20,6)) AS APIPCTMINC,
        TRY_CAST(APIPCTMDEC AS DECIMAL(20,6)) AS APIPCTMDEC,
        TRY_CAST(AORGPIAMT AS DECIMAL(20,6)) AS AORGPIAMT,
        TRY_CAST(ARMINDEX AS DECIMAL(20,6)) AS ARMINDEX,
        TRY_CAST(ARMIRRATE AS DECIMAL(20,6)) AS ARMIRRATE,
        AOIRCHGDT,
        AIRRNDTP,
        AIRRNDDESC,
        TRY_CAST(AIRRNDFACT AS DECIMAL(20,6)) AS AIRRNDFACT,
        ARMPLANID,
        ARMPLANDES,
        ARMINDCO,
        ARMINDDESC,
        ...
        SUBDIV,
        COUNTYCODE,
        TRY_CAST(COUNTYTAX AS DECIMAL(19,3)) AS COUNTYTAX,
        TRY_CAST(HAZMONTHLY AS DECIMAL(19,3)) AS HAZMONTHLY,
        LASTANALDT,
        TRY_CAST(ESCMINBALC AS DECIMAL(19,3)) AS ESCMINBALC,
        TRY_CAST(LASTANALOS AS DECIMAL(19,3)) AS LASTANALOS,
        OVSHTCHGDT,
        MORTSSNO,
        COMORTSSNO,
        SSNCERTDT,
        ...
        SSNVERDATE,
        SETUPDATE,
        TRY_CAST(SUSPBAL AS DECIMAL(19,3)) AS SUSPBAL,
        TRY_CAST(RESTESCBAL AS DECIMAL(19,3)) AS RESTESCBAL,
        CRQUALCODE,
        INTONLYIND,
        PAYFULLDT,
        SERVSOLDDT,
        ...
        COMTGRDOB,
        PROPUNITNO,
        TRY_CAST(LTV AS DECIMAL(14,3)) AS LTV,
        BILLADDR3,
        BILLADDR4,
        BILLCITY,
        BILLSTATE,
        ...
        BILLADDR2,
        USR1POS3A,
        TRY_CAST(CHGOFFBAL AS DECIMAL(17,3)) AS CHGOFFBAL,
        TRY_CAST(ACC_LATECA AS DECIMAL(17,3)) AS ACC_LATECA,
        TRY_CAST(LATECF AS DECIMAL(17,6)) AS LATECF,
        GRACEDAYS,
        LCCODE,
        PHONE,
        PHONE2,
        ...
        CSBORCBC,
        CSBORCBST,
        TRY_CAST(FIRSTFF1 AS DECIMAL(17,3)) AS FIRSTFF1,
        ASSUMDATE,
        VACDATE,
        LNMODDATE,
        USR20POS1A,
        TRY_CAST(RECOVERCAB AS DECIMAL(17,3)) AS RECOVERCAB,
        TRY_CAST(NONRECCAB AS DECIMAL(17,3)) AS NONRECCAB,
        TRY_CAST(THIRDPRCB AS DECIMAL(17,3)) AS THIRDPRCB,
        TRY_CAST(PENDPIAMT AS DECIMAL(17,3)) AS PENDPIAMT,
        ADLCBN1,
        ADLCSTN1,
        ADLCBS,
        ADLCBC,
        ...
        ADLCBPN,
        LASTFPAYDT,
        TRY_CAST(YTDINTAMT AS DECIMAL(19,3)) AS YTDINTAMT,
        TRY_CAST(YTDPPAMT AS DECIMAL(19,3)) AS YTDPPAMT,
        YTDTAXAMT,
        YTDHAZAMT,
        USR1PO4A,
        DAYDELIQUE,
...
WITH cte_data AS (
	SELECT
	    TRY_CAST(v.col1 AS STRING) AS Investor_Type
	   ,TRY_CAST(v.col2 AS STRING) AS Investor_Name
	   ,TRY_CAST(v.col3 AS STRING) AS Perm_Inv
	   ,TRY_CAST(v.col4 AS STRING) AS Perm_Cat
	   ,TRY_CAST(v.col5 AS STRING) AS Recon_Method
	   ,TRY_CAST(v.col6 AS STRING) AS P_I_DDA_Number
	   ,TRY_CAST(v.col7 AS STRING) AS T_I_DDA_Number
	   ,TRY_CAST(v.col8 AS STRING) AS G_L_Corp_Code
	   ,TRY_CAST(v.col9 AS STRING) AS ABA_Number
	   ,TRY_CAST(v.col10 AS STRING) AS Principal_Payee
	   ,TRY_CAST(v.col11 AS STRING) AS Principal_G_L_Acct_No
	   ,TRY_CAST(v.col12 AS STRING) AS Principal_GL_Number
	   ,TRY_CAST(v.col13 AS STRING) AS Principal_G_L_Cost_Center
	   ,TRY_CAST(v.col14 AS STRING) AS Escrow_Replacement_Reserve_Payee
	   ,TRY_CAST(v.col15 AS STRING) AS Escrow_Replacement_Reserve_G_L_Acct_No
	   ,TRY_CAST(v.col16 AS STRING) AS Escrow_Replacement_Reserve_G_L_Cost_Center
	   ,TRY_CAST(v.col17 AS STRING) AS Interest_Receivable_Payee
	   ,TRY_CAST(v.col18 AS STRING) AS Interest_Receivable_G_L_Acct_No
	   ,TRY_CAST(v.col19 AS STRING) AS Interest_Receivable_G_L_Cost_Center
	   ,TRY_CAST(v.col20 AS STRING) AS Servicing_Fee_Payee
	   ,TRY_CAST(v.col21 AS STRING) AS Servicing_Fee_G_L_Acct_No
	   ,TRY_CAST(v.col22 AS STRING) AS Servicing_Fee_G_L_Cost_Center
	   ,TRY_CAST(v.col23 AS STRING) AS Late_Charge_Payee
	   ,TRY_CAST(v.col24 AS STRING) AS Late_Charge_G_L_Acct_No
	   ,TRY_CAST(v.col25 AS STRING) AS Late_Charge_G_L_Cost_Center
	   ,TRY_CAST(v.col26 AS STRING) AS Loans_in_Process_Payee
	   ,TRY_CAST(v.col27 AS STRING) AS Loans_in_Process_G_L_Acct_No
	   ,TRY_CAST(v.col28 AS STRING) AS Loans_in_Process_G_L_Cost_Center
	   ,TRY_CAST(v.col29 AS STRING) AS Loans_in_Process_Payee_2
	   ,TRY_CAST(v.col30 AS STRING) AS Part_Conta_G_L_Acct_No
	   ,TRY_CAST(v.col31 AS STRING) AS Part_Conta_G_L_Cost_Center
	   ,TRY_CAST(v.col32 AS STRING) AS Interest_Income_Payee
	   ,TRY_CAST(v.col33 AS STRING) AS Interest_Income_G_L_Acct_No
	   ,TRY_CAST(v.col34 AS STRING) AS Interest_Income_G_L_Cost_Center
	   ,TRY_CAST(v.col35 AS STRING) AS Loans_Sold_Payee
	   ,TRY_CAST(v.col36 AS STRING) AS Loans_Sold_G_L_Acct_No
	   ,TRY_CAST(v.col37 AS STRING) AS Loans_Sold_G_L_Cost_Center
	   ,TRY_CAST(v.col38 AS STRING) AS P_I_Adv_Payee
	   ,TRY_CAST(v.col39 AS STRING) AS Doc_Custod_Payee
	   ,TRY_CAST(v.col40 AS STRING) AS Penalty_Int_Penalty_Payee 
	   ,TRY_CAST(v.col41 AS STRING) AS Penalty_Int_Penalty_G_L_Acct_No 
	   ,TRY_CAST(v.col42 AS STRING) AS Penalty_Int_Penalty_G_L_Cost_Center
	   ,TRY_CAST(v.col43 AS STRING) AS Penalty_Int_Penalty
	   ,TRY_CAST(v.col44 AS STRING) AS Straightline_Disc_Unearned_Payee
	   ,TRY_CAST(v.col45 AS STRING) AS Straightline_Disc_Unearned_G_L_Acct_No
	   ,TRY_CAST(v.col46 AS STRING) AS Straightline_Disc_Unearned_G_L_Cost_Center
	   ,TRY_CAST(v.col47 AS STRING) AS Straightline_Disc_Earned_Payee
	   ,TRY_CAST(v.col48 AS STRING) AS Straightline_Disc_Earned_G_L_Acct_No
	   ,TRY_CAST(v.col49 AS STRING) AS Straightline_Disc_Earned_G_L_Cost_Center
	   ,TRY_CAST(v.col50 AS STRING) AS FASB_91_1_Unearned_Fees_Payee
	   ,TRY_CAST(v.col51 AS STRING) AS FASB_91_1_Unearned_Fees_G_L_Acct_No
	   ,TRY_CAST(v.col52 AS STRING) AS FASB_91_1_Unearned_Fees_G_L_Cost_Center
	   ,TRY_CAST(v.col53 AS STRING) AS FASB_91_1_Earned_Fees_Payee
	   ,TRY_CAST(v.col54 AS STRING) AS FASB_91_1_Earned_Fees_G_L_Acct_No
	   ,TRY_CAST(v.col55 AS STRING) AS FASB_91_1_Earned_Fees_G_L_Cost_Center
	   ,TRY_CAST(v.col56 AS STRING) AS FASB_91_2_Unearned_Cost_Payee
	   ,TRY_CAST(v.col57 AS STRING) AS FASB_91_2_Unearned_Cost_G_L_Acct_No
	   ,TRY_CAST(v.col58 AS STRING) AS FASB_91_2_Unearned_Cost_G_L_Cost_Center
	   ,TRY_CAST(v.col59 AS STRING) AS FASB_91_2_Earned_Cost_Payee
	   ,TRY_CAST(v.col60 AS STRING) AS FASB_91_2_Earned_Cost_G_L_Acct_No
	   ,TRY_CAST(v.col61 AS STRING) AS FASB_91_2_Earned_Cost_G_L_Cost_Center
	   ,TRY_CAST(v.col62 AS STRING) AS FASB_91_3_Unearned_Cost_Payee
	   ,TRY_CAST(v.col63 AS STRING) AS FASB_91_3_Unearned_Cost_G_L_Acct_No
	   ,TRY_CAST(v.col64 AS STRING) AS FASB_91_3_Unearned_Cost_G_L_Cost_Center
	   ,TRY_CAST(v.col65 AS STRING) AS FASB_91_3_Earned_Cost_Payee
	   ,TRY_CAST(v.col66 AS STRING) AS FASB_91_3_Earned_Cost_G_L_Acct_No
	   ,TRY_CAST(v.col67 AS STRING) AS FASB_91_3_Earned_Cost_G_L_Cost_Center
	   ,TRY_CAST(v.col68 AS STRING) AS FASB_91_4_Unearned_Payee
	   ,TRY_CAST(v.col69 AS STRING) AS FASB_91_4_Unearned_G_L_Acct_No
	   ,TRY_CAST(v.col70 AS STRING) AS FASB_91_4_Unearned_G_L_Cost_Center
	   ,TRY_CAST(v.col71 AS STRING) AS FASB_91_4_Earned_Payee
	   ,TRY_CAST(v.col72 AS STRING) AS FASB_91_4_Earned_G_L_Acct_No
	   ,TRY_CAST(v.col73 AS STRING) AS FASB_91_4_Earned_G_L_Cost_Center
	FROM
	(
	VALUES
...
WITH cte_bronze_dmi_s2tv AS (
	SELECT
		...
		,PostingType
		,VariableBeforeAfter
		--,TRY_CAST(REPLACE(REPLACE(REPLACE(TRIM(VariableBeforeAfter), ',', ''), '(',''),')','') AS DECIMAL(12,2))	AS VariableBeforeAfter
		,`Date`
		,ExceptionCodes
		,LoanType
		,SLCode1
...
casted_dmi_transaction_codes AS (
    SELECT
        TRY_CAST(`SHEET` AS STRING) AS SHEET,
        TRY_CAST(`TRAN_CODE` AS STRING) AS TRAN_CODE,
